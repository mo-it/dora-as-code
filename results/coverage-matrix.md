...
| REQ-003 | 9(4)(b) | Implement least-privilege access controls | DIRECT | DIRECT |
| REQ-004 | 9(4)(b) | Prevent privilege escalation through RBAC bindings | DIRECT | DIRECT |
| REQ-026 | 9(4)(c) | Implement authentication and session management controls | ASSERTED | ASSERTED |
...
| REQ-006 | 11(1) | Ensure ICT system resilience through resource governance | DIRECT | DIRECT |
| REQ-007 | 11(1) | Ensure high availability of critical ICT services | DIRECT | DIRECT |
